...
! function(t) {
    function i() {
        ...
        }), o.add("touch desktop scale-1 scale-2 scale-3 wrapper opened opening fixed inline hover slider slide loading noanimation fastanimation"), a.add("slide anchor"), r.add("open opening close closing prev next slideTo sliding click pinch scroll resize orientationchange load loading loaded transitionend webkitTransitionEnd"), d = {
        ...
        }, l.$body.addClass(t[e].support.touch ? o.touch : o.desktop), l.$wndw.on(r.scroll, function(t) {
    ...
    if (!t[e]) {
        ...
        t[e] = function(t, i, e) {
            ...
            _initAnchors: function() {
                var i = this,
                    s = t();
                if (this.$node.is("a"))
                    for (var n in t[e].media) s = s.add(this.$node.filter(function() {
            ...
            _initSlidesFromAnchors: function() {
                ...
                this.nodes.$anchors.each(function(e) {
                    var s = t(this),
                        n = t('<div class="' + o.slide + " " + o.loading + '" />').data(a.anchor, s).appendTo(i.nodes.$sldr);
            ...
            _complementOptions: function() {
                if ("undefined" == typeof this.opts.wrapper.target && (this.opts.wrapper.target = this.$node.is("a") ? "window" : this.$node), "window" != this.opts.wrapper.target && "string" == typeof this.opts.wrapper.target && (this.opts.wrapper.target = t(this.opts.wrapper.target)), this.opts.show = d.complBoolean(this.opts.show, "window" != this.opts.wrapper.target), t.isNumeric(this.opts.slides.width)) this.slides.widthPercentage = !1, this.opts.slides.visible = d.complNumber(this.opts.slides.visible, 1);
                else {
        ...
        }, t[e].constants = {}, t[e].debug = function(t) {}, t[e].deprecated = function(t, i) {
...
function(t) {
    ...
    t[d].prototype["_addon_" + l] = function() {
        ...
        this.nodes.$prev = null, this.nodes.$next = null, this.nodes.$clse = null, ("boolean" == typeof h || "string" == typeof h && "inline" == h) && (h = {
            prev: h,
            next: h
        }), "undefined" == typeof h.close && (h.close = this.vars.fixed), this.nodes.$slides.length < 2 && (h.prev = !1, h.next = !1), t.each({
            prev: "prev",
            next: "next",
            close: "clse"
        }, function(n, a) {
    ...
    t[a].prototype["_addon_" + r] = function() {
        ...
        if (p.add) {
            ...
            this.nodes.$slides.each(function(i) {
                ...
                for (var n = 0, o = l.slides.visible; o > n; n++) l.nodes.$capt.children().eq(n).html(l.nodes.$sldr.children().eq(l.slides.index + n).data(e.caption) || "")
            })
        }
    }, t[a].defaults[r] = {
        add: !1,
                ...
                if (this.nodes.$slides.length > 1) {
                    ...
                    u.on("panstart panleft panright panend swipeleft swiperight", function(t) {
                        ...
                        if (l.nodes.$sldr.removeClass(i.noanimation).addClass(i.fastanimation), n.transitionend(l.nodes.$sldr, function() {
                            ...
                            else var o = l.nodes.$slides.first().width(),
            ...
            if ("string" == typeof p.target && (p.target = t(p.target)), p.target instanceof t ? this.nodes.$pagr = p.target : (this.nodes.$pagr = t('<div class="' + i.pagination + " " + i[p.type] + '" />').appendTo(this.nodes.$wrpr), this.nodes.$uibg || (this.nodes.$uibg = t('<div class="' + i.uibg + '" />').prependTo(this.nodes.$wrpr))), "function" != typeof p.anchorBuilder) switch (p.type) {
                case "thumbnails":
                    ...
                    this.vars.fixed ? p.anchorBuilder = function(i) {
                        return c + t(this).data(e.anchor).attr("href") + h
